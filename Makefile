...
SRC		= 	main.c \
			...
			mx_clear_flags.c \
			mx_read_dir.c \
			mx_ls_get_uid_name.c \
			mx_create_param_arr.c \
			mx_create_flags_str.c \
			mx_ls_get_acl_inf.c \
			mx_ls_get_gid_name.c \
			mx_get_lstat.c \
			mx_ls_get_print_name.c \
			...
			mx_ls_print_color.c \
			mx_ls_sort.c \
			mx_ls_sort_default.c \
			mx_ls_sort_flag_r.c \
			mx_ls_sort_flag_big_s.c \
			mx_ls_sort_flag_c.c \
			mx_ls_sort_flag_t.c \
			mx_ls_sort_flag_u.c \
			mx_untill_del_tls.c \
			mx_until_get_size_arr.c \
			mx_until_create_char_arr.c \
